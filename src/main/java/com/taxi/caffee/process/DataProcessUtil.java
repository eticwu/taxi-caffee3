...
public class DataProcessUtil {
	...
	for (String p : phase) {
		...
		propertyBuilder.append(p.substring(0, 1).toUpperCase()).append(p.substring(1))
			.toString();
	    }
	}
	...
	for (String p : phase) {
	    ...
	    classBuilder.append(p.substring(0, 1).toUpperCase()).append(p.substring(1));
	}
	...
	getterBuilder.append("get").append(property.substring(0, 1).toUpperCase())
	...
	setterBuilder.append("set").append(property.substring(0, 1).toUpperCase())
		.append(property.substring(1));
    ...
    public static String getJavaFullType(String type) {
